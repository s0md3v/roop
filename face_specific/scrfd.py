...
class SCRFD:
    ...
    def autodetect(self, img, max_num=0, metric='max'):
        ...
        bboxes_merged = np.concatenate([bboxes_large, bboxes_small], axis=0)
        kpss_merged = np.concatenate([kpss_large, kpss_small], axis=0)
