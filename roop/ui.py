...
def create_root(start: Callable[[], None], destroy: Callable[[], None]) -> ctk.CTk:
    ...
    video_quality_display = ctk.CTkLabel(root, textvariable=video_quality_value, justify="center")
    video_quality_display.place(relx=0.2, rely=0.7)

    video_quality_slider = ctk.CTkSlider(root, from_=0, to=51, variable=video_quality_value, cursor="hand2")
