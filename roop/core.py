...
def parse_args() -> None:
    ...
    program.add_argument('--output-video-encoder', help='encoder of the output video', dest='output_video_encoder', default='libx264', choices=['libx264', 'libx265', 'libvpx-vp9'])
    program.add_argument('--output-video-quality', help='quality of the output video', dest='output_video_quality', type=int, default=18, choices=range(52), metavar='[0-51]')
